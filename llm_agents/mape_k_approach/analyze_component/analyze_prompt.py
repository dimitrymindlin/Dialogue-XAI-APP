...
<<Task>>:
The user sent the following message: "{user_message}". The user signals {monitor_display_result} and is in a {monitor_cognitive_state} cognitive state of engagement.
