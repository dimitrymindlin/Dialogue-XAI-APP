...
Think step by step and provide a reasoning how the user model should change given the user message, the conversation history and the current user model. If no changes are necessary, give the reasoning and return an empty list as changes [].
"""
