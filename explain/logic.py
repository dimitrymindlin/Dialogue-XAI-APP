    ...
    def __init__(self,
        ...
        if self.use_llm_agent:
            if self.use_llm_agent == "o1":
                ...
                from llm_agents.mape_k_component_mixins import MapeK4BaseAgent as Agent
                ...
                from llm_agents.mape_k_component_mixins import MapeKApproval4BaseAgent as Agent
