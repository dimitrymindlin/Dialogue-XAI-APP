...
class TestInstances:
    ...
    def get_test_instances(self,
        ...
        for instance_id in self.diverse_instance_ids:
            ...
            similar_instances = sort_instances_by_complexity(original_instance, similar_instances, feature_importances,
...
def calculate_prediction_task_complexity(original_instance,
                                         new_instance,
                                         feature_importances,
                                         model_certainty_old,
                                         model_certainty_new,
    ...
    weighted_diff = \
        sum(feature_importances[feature] * abs(new_instance[feature].values - original_instance[feature].values)
...
def sort_instances_by_complexity(original_instance,
                                 new_instances,
                                 feature_importances,
                                 pred_f,
