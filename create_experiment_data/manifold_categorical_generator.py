...
class ManifoldAwareCategoricalGenerator:
    ...
    def _generate_categorical_variants(self, original_instance: pd.DataFrame, max_variants: int = 200) -> List[pd.DataFrame]:
    ...
    def generate_instances(self, original_instance: pd.DataFrame, target_count: int) -> Dict[str, Any]:
        ...
        print(f"[ManifoldCategoricalGenerator] Generated {len(valid_instances)}/{target_count} valid instances from {attempts} attempts (success rate: {success_rate:.1%})")
